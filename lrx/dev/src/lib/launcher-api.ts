...
export const filewatcher_api = [
	{
		...
		description: 'Watch LORG_TEMPLATE_DIR for changes via SSE (Server-Sent Events)',
...
export const projects_api = [
	...
	},
	{
		...
		description: 'Create a new project and start its lorg-app instance',
		category: '/api/project',
		defaultBody: {
			name: 'my-project'
		},
		examples: [
			{
				name: 'Create project',
				description: 'Creates project directory, saves to DB, and starts lorg-app on an available port',
...
export const tools_api = [
	{
		...
		description: 'Start or retrieve a lorg-tool server instance by ID',
		category: '/api/tool',
		examples: [
			{
				name: 'Start tool server',
				description: 'Starts a new lorg-tool server or returns existing one if already active',
				request: { id: 'abc123' },
				response: {
					status: 200,
...
export const update_api = [
	{
		...
		description: 'Check if a newer version of lorg is available',
		category: '/api/update',
		examples: [
			{
				name: 'Check update',
	...
	},
	{
		...
		method: 'POST',
		path: '/api/update',
		description: 'Download and install the latest version of all lorg binaries',
		category: '/api/update',
		examples: [
			{
				name: 'Update binaries',
				description: 'Downloads and replaces lorg, lorg-app, and lorg-tool binaries',
				request: {},
				response: {
					status: 200,
					body: { previous_version: 'v2026.3.6', new_version: 'v2026.3.7', results: [{ binary: 'lorg', status: 'updated', path: '/usr/local/bin/lorg' }] }
				}
			}
		]
	}
