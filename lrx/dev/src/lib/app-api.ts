...
export const tools_api = [
	{
		...
		description: 'Start a new lorg-tool server instance on an available port',
		category: '/api/tool',
		examples: [
			{
				name: 'Start tool server',
				description: 'Launches a lorg-tool process and returns connection details',
				request: {},
				response: {
					status: 200,
				...
				response: {
					...
					body: {
						tools: [
							...
							{ name: 'version', description: 'Get lorg version information' }
						],
						count: 2
					}
				}
		...
		examples: [
			{
				...
				response: {
					status: 200,
					body: { tools: [{ name: 'hello', description: 'Say hello' }, { name: 'version', description: 'Get lorg version information' }] }
				}
			},
			{
			...
			},
			{
				...
				description: 'Returns lorg version information',
				request: {
					jsonrpc: '2.0',
					id: 3,
					method: 'tools/call',
		...
		examples: [
			{
				...
				description: 'Writes .mcp.json with lorg MCP SSE config and CLAUDE.md with user-provided content',
				request: {
