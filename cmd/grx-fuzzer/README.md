...
A standalone command-line fuzzing tool for lorg that supports both HTTP/1.x and HTTP/2 protocols.
...
```bash
go install github.com/campbellcharlie/lorg/cmd/grx-fuzzer@latest
```
