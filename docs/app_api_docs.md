...
Tool sub-instances are no longer supported. The endpoint is kept as a tombstone returning `410 Gone` so old clients fail fast instead of silently misbehaving.
